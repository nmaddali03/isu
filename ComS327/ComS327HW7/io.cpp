...
{
  const character_t *const *c1 = (const character_t* const*)v1; //v1;
  const character_t *const *c2 = (const character_t* const*)v2; //v2;
...
static character_t *io_nearest_visible_trainer()
{
  ...
  c = (character_t **)malloc(world.cur_map->num_trainers * sizeof (*c)); //malloc...
                                     ...
                                     uint32_t count)
{
  ...
  s = (char (*)[40])malloc(count * sizeof (*s)); //malloc(count...)
...
static void io_list_trainers()
{
  ...
  c = (character_t **)malloc(world.cur_map->num_trainers * sizeof (*c)); //malloc(world...)
