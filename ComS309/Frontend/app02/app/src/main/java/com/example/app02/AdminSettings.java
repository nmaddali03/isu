...
public class AdminSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editAddAdmin = findViewById(R.id.editAddAdmin);
    ...
    public void suspendUser(){
        ...
        if (editSuspendUser.getText().toString().isEmpty()) {
            ...
            String suspendUser = editSuspendUser.getText().toString();
            suspend = true;
            /*
            try{
                NetworkCalls.updateSuspended(suspendUser, suspend);
            } catch (JSONException e) {
                e.printStackTrace();
            }
             */
            //suspend user given the username -- change suspend boolean to true
        }
        // calling a method to post the data and passing our name and job.
    ...
    public void addAdmin() {
        if (editAddAdmin.getText().toString().isEmpty()) {
            Toast.makeText(AdminSettings.this, "Please enter a username to suspend", Toast.LENGTH_SHORT).show();
            return;
        }
    }
