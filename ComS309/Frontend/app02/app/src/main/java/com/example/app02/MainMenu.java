...
public class MainMenu extends AppCompatActivity {
    ...
    public static CurrentTeam currTeam;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLeader = findViewById(R.id.btnGroupLeader);
    ...
    /**
     * opens group leader decision page
     */
    public void openGroupLeaderDecision(){
        menuMusic.stop();
        Intent intent = new Intent(this, GroupLeaderDecision.class);
        startActivity(intent);
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
    }
    ...
    public void openChat(){
        ...
        menuMusic.stop();
        Intent intentChat = new Intent(this, messageConnect.class);
        intentChat.putExtra("timeStamp", timeStamp);
        intentChat.putExtra("username", user);
        intentChat.putExtra("setBG", setBG);
