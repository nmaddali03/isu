...
public class items extends AppCompatActivity {
    ...
    public boolean mountainsClicked;
    public boolean halloweenClicked;
    public boolean forestClicked;
    ...
    public boolean checkItems(String setBG){
        if(forestClicked&&(setBG.equals("forest"))){
            return true;
        }
        if(halloweenClicked&&(setBG.equals("halloween"))){
            return true;
        }
        if(mountainsClicked&&(setBG.equals("mountains"))){
            return true;
        }
        return false;
    }
